...
QIntValidator::State GuiValidators::observeIntEdited
  ( QLineEdit* arg_le
  , QString arg_newText
  , int arg_bottom
  , int arg_top
  )
{
  ...
  // state check: empty input.
  if (arg_newText.isEmpty())
  {
    // set back to flat-white.
    arg_le->setStyleSheet("QLineEdit { background-color: #ffffffff");
...
QDoubleValidator::State GuiValidators::observeDoubleEdited
  ( QLineEdit* arg_le
  , QString arg_newText
  )
{
...
QRegularExpressionValidator::State GuiValidators::observeIPv4Edited
  ( QLineEdit* arg_le
  , QString arg_newText
  )
{
...
QRegularExpressionValidator::State GuiValidators::observeFqFileEdited
  ( QLineEdit* arg_le
  , QString arg_newText
...
QIntValidator::State GuiValidators::checkIntEdited
  ( QString arg_newText
  , int arg_bottom
  , int arg_top
  )
...
QDoubleValidator::State GuiValidators::checkDoubleEdited
  ( QString arg_newText
  )
{
...
QRegularExpressionValidator::State GuiValidators::checkIPv4Edited
  ( QString arg_newText
  )
{
...
QRegularExpressionValidator::State GuiValidators::checkFqFileEdited
